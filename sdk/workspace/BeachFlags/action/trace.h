...
// ライントレースクラス
class Trace : public Run
{
public:
	Trace(LeftOrRight lineEdge, double Kp, double Ki, double Kd, int speedMin, int speedMax);
	Trace(LeftOrRight lineEdge, double Kp, double Ki, double Kd,
